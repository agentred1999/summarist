      ...
      <nav className="nav">
        <div className="nav__wrapper">
          <figure className="nav__img--mask">
            <Image className="nav__img" src="/assets/logo.png" alt="logo" width={200} height={50} />
          </figure>
          <ul className="nav__list--wrapper">
            <li className="nav__list nav__list--login" onClick={() => dispatch(toggleAuthModal())}>Login</li>
            ...
            <div className="landing__wrapper">
              <div className="landing__content">
                ...
                <div className="landing__content__subtitle">
                  ...
                  individuals who barely have time to read,<br className="remove--tablet" />
                  and even people who don&apos;t like to read.
                </div>
                <button className="btn home__cta--btn" onClick={() => dispatch(toggleAuthModal())}>Login</button>
              </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="numbers__wrapper">
              ...
              <div className="numbers">
                <div className="numbers__icon numbers__star--icon"><BsStarFill /><BsStarHalf /></div>
