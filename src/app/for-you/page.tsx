      ...
      <section style={{ marginBottom: '40px' }}>
        ...
        {loading ? (
          ...
          <Link href={`/book/${selected.id}`} style={{ textDecoration: 'none' }}>
            <div style={{
              display: 'flex', gap: '24px', backgroundColor: '#fff3d7',
              borderRadius: '8px', padding: '24px', cursor: 'pointer', maxWidth: '700px'
            }}>
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: '14px', color: '#032b41', marginBottom: '16px', lineHeight: 1.5 }}>
                  {selected.subTitle}
                </div>
